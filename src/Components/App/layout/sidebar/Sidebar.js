    ...
    <ul className="sidebar-nav" id="sidebar-nav">
      ...
      {/* <li className="nav-item">
        ...
        <ul id="icons-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <Link to="/Navadmin/bootstrap-icons">
      ...
      <li className="nav-item">
        <Link className="nav-link collapsed" to="/admin/web-managment">
      ...
      {/* <li className="nav-item">
        <Link className="nav-link collapsed" to="/Navadmin/register">
      ...
      <li className="nav-item">
        <Link className="nav-link collapsed" to="/Navadmin/login">
      ...
      <li className="nav-item">
        <Link className="nav-link collapsed" to="/Navadmin/blank">
